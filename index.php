...
$user = $tweet->get('https://api.twitter.com/1.1/users/show.json?screen_name=dev1showmb');
...
<html lang="en">
	...
	$app_id = '884290914990957';
	$app_secret = 'c3f4a6281bc5109b3e17344781c224cf';
	$redirect_url='http://dev1.showmb.com/maged/';
	 ...
	 //4. if fb sess exists echo name 
	 	if(isset($sess)){
			...
			//create request object,execute and capture response
	 		$request_friends = new FacebookRequest($sess,'GET','/me/friends');
			$request_friends = $request_friends->execute();
$request_friends = $request_friends->getGraphObject(); 
        ...
        foreach($country as $row){
            ...
            $users->update_user_login($user_id , $user_friendscount);
			header("Location: home.php");
			}
